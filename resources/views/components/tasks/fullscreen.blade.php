    ...
    <div class="max-w-7xl mx-auto px-4 lg:px-8">
        ...
        <div class="{{ $bg }} overflow-hidden shadow-sm rounded-lg my-6">
            <div class="p-6">
                ...
                <p class="pt-4 {{$text_color}}">{{ __('Click the Start viewing button to open the ad unit. Wait until the timer ends to receive your 1 Robux reward. If you close the ad before the timer ends, the reward will not be awarded.') }}</p>
            </div>
        </div>
    </div>
